  ...
  return (
    <section className="py-32">
      <div className="container">
        ...
        <div className="relative overflow-hidden rounded-xl border border-border/20 p-8 md:p-6 bg-transparent backdrop-blur-sm">
          ...
          <Tabs defaultValue="overview" className="mt-8">
            <TabsList className="mx-auto grid w-full max-w-md grid-cols-3 gap-2 bg-transparent border-0">
              <TabsTrigger 
                value="overview" 
                className="data-[state=active]:bg-primary/10 data-[state=active]:text-primary border border-border/30 hover:bg-muted/30 transition-all duration-200 rounded-lg"
              >
                Overview
              </TabsTrigger>
              <TabsTrigger 
